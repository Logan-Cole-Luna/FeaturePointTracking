...
class Index(IndexOpsMixin, PandasObject):
    ...
    def reindex(
        ...
        Examples
        --------
        >>> idx = pd.Index(['car', 'bike', 'Dataset', 'tractor'])
        >>> idx
        Index(['car', 'bike', 'Dataset', 'tractor'], dtype='object')
    ...
    def where(self, cond, other=None) -> Index:
        ...
        >>> idx
        Index(['car', 'bike', 'Dataset', 'tractor'], dtype='object')
        >>> idx.where(idx.isin(['car', 'Dataset']), 'other')
        Index(['car', 'other', 'Dataset', 'other'], dtype='object')
        """
        if isinstance(self, ABCMultiIndex):
            raise NotImplementedError(
